...
#     parser.add_argument("--resolution",type=float,default=5,help="specify the resolution to skip for super high resolution maps (better than 2A)")
...
#     parser.add_argument("--denoise_mask",help="Enable automatic noise removal mask",action="store_true")
#         # ===== 新增推理优化参数 =====
#     parser.add_argument('--use_amp', type=bool, default=True,
#                        help='Use Automatic Mixed Precision for faster inference')
#     parser.add_argument('--use_jit', type=bool, default=False,
#                        help='Use TorchScript JIT compilation (may not work for all models)')
#     parser.add_argument('--optimize_memory', type=bool, default=True,
#                        help='Enable memory optimization (cudnn.benchmark, etc.)')
